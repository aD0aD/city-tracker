...
export const cityToProvince: Record<string, string> = {
  ...
  '普陀区': '上海市', '虹口区': '上海市', '杨浦区': '上海市', '浦东新区': '上海市',
  ...
  '恩施土家族苗族自治州': '湖北省', '仙桃市': '湖北省', '潜江市': '湖北省',
  '天门市': '湖北省', '神农架林区': '湖北省',
  ...
  // 西藏自治区
  '拉萨市': '西藏自治区', '昌都市': '西藏自治区', '山南市': '西藏自治区',
  '日喀则市': '西藏自治区', '那曲市': '西藏自治区', '阿里地区': '西藏自治区',
  '林芝市': '西藏自治区',
  ...
  // 青海省
  '西宁市': '青海省', '海东市': '青海省', '海北藏族自治州': '青海省',
  '黄南藏族自治州': '青海省', '海南藏族自治州': '青海省',
  ...
  '双河市': '新疆维吾尔自治区', '可克达拉市': '新疆维吾尔自治区',
  '昆玉市': '新疆维吾尔自治区', '胡杨河市': '新疆维吾尔自治区',
  '新星市': '新疆维吾尔自治区', '白杨市': '新疆维吾尔自治区',
  
  // 台湾省
  '台北市': '台湾省', '新北市': '台湾省', '桃园市': '台湾省', '台中市': '台湾省',
  '台南市': '台湾省', '高雄市': '台湾省', '基隆市': '台湾省', '新竹市': '台湾省',
  '嘉义市': '台湾省', '新竹县': '台湾省', '苗栗县': '台湾省', '彰化县': '台湾省',
  '南投县': '台湾省', '云林县': '台湾省', '嘉义县': '台湾省', '屏东县': '台湾省',
  '宜兰县': '台湾省', '花莲县': '台湾省', '台东县': '台湾省', '澎湖县': '台湾省',
  '金门县': '台湾省', '连江县': '台湾省',
  ...
  '香港': '香港特别行政区',
  // 香港各区
  '中西区': '香港特别行政区', '湾仔区': '香港特别行政区', '东区': '香港特别行政区',
  '南区': '香港特别行政区', '深水埗区': '香港特别行政区', '油尖旺区': '香港特别行政区',
  '九龙城区': '香港特别行政区', '黄大仙区': '香港特别行政区', '观塘区': '香港特别行政区',
  '荃湾区': '香港特别行政区', '屯门区': '香港特别行政区', '元朗区': '香港特别行政区',
  '北区': '香港特别行政区', '大埔区': '香港特别行政区', '沙田区': '香港特别行政区',
  '西贡区': '香港特别行政区', '葵青区': '香港特别行政区', '离岛区': '香港特别行政区',
  
  // 澳门特别行政区
  '澳门特别行政区': '澳门特别行政区',
  '澳门': '澳门特别行政区',
  // 澳门各区
  '花地玛堂区': '澳门特别行政区', '花王堂区': '澳门特别行政区', '望德堂区': '澳门特别行政区',
  '大堂区': '澳门特别行政区', '风顺堂区': '澳门特别行政区', '嘉模堂区': '澳门特别行政区',
  '路凼填海区': '澳门特别行政区', '圣方济各堂区': '澳门特别行政区',
...
export function getProvinceByCity(city: string): string | null {
  ...
  // 尝试去掉"市"、"县"等后缀
  const cityWithoutSuffix = city.replace(/[市县区]$/, '')
  if (cityToProvince[cityWithoutSuffix]) {
    return cityToProvince[cityWithoutSuffix]
  }
  
  // 尝试添加"市"后缀
  if (!city.endsWith('市') && !city.endsWith('县') && !city.endsWith('区')) {
    const cityWithSuffix = city + '市'
    if (cityToProvince[cityWithSuffix]) {
      return cityToProvince[cityWithSuffix]
    }
  }
